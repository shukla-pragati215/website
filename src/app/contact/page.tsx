              ...
              <div className="flex gap-6">
                {[
                  ...
                  <a
                    key={i}
                    href={social.url}
                    className="w-10 h-10 flex items-center justify-center rounded-full border border-white/10 hover:border-cyan-500 hover:text-cyan-400 transition-all"
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          >
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:border-cyan-500 focus:outline-none transition-colors appearance-none">
                  <option className="bg-[#050505]">Select a manifestation...</option>
                  <option className="bg-[#050505]">Social Media Marketing</option>
                  <option className="bg-[#050505]">Performance Marketing</option>
                  <option className="bg-[#050505]">Videography</option>
                  <option className="bg-[#050505]">Website Development</option>
                  <option className="bg-[#050505]">AI Automation</option>
                </select>
              </div>
